...
class DeepExplorer(object):
    ...
    def construct_refheight_room2floors(self):
        ...
        self.floor_reference_height['Scioto']['floor0']['step_budget'] = 500
        ...
        self.floor_reference_height['Scioto']['floor1']['step_budget'] = 500
    ...
    def explore_oneroom_onefloor(self,
                                  room_json_file,
                                  img_save_dir,
                                  random_seed = 0,):
...
def main():
    ...
    input_room_list = glob.glob('./data/datasets/pointnav/gibson/v1/val/content/*.json.gz')

    twofloor_rooms = ['Mosquito', 'Sands', 'Scioto']
    ...
    for seed_num_idx in range(len(random_seeds)):
        for idx, input_room in enumerate(input_room_list):
            ...
            if roomname not in twofloor_rooms:
                atm_explorer = DeepExplorer(
                    pretrained_model=motiontask_jointplanner_pretrained_model,
                    step_size=step_size,
                    turn_angle=turn_angle,
                    delete_imgs=delete_imgs)
                start_pos, start_rot, action_list = deep_explorer.explore_oneroom_onefloor(input_room,
                                                                                           output_dir,
                ...
                deep_explorer = DeepExplorer(
                    ...
                    turn_angle=turn_angle,
                    delete_imgs=delete_imgs)
                nav_result_2floors = deep_explorer.explore_oneroom_twofloors(input_room,
                                                                             output_dir,
                                                                             random_seed=random_seeds[seed_num_idx])
